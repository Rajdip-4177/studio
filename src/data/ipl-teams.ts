...
export const teamsData: TeamStats[] = [
  ...
  { id: "RR", name: "Rajasthan Royals", logoUrl: "https://documents.iplt20.com/ipl/RR/Logos/RR_Logo.png", city: "Jaipur", state: "Rajasthan", lifeExpectancy: 67.9, infantMortalityRate: 37, literacyRate: 66.1, attendanceRatio: 89.5, perCapitaIncome: parseIncome("110,606") },
